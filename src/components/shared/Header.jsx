...
function Header({ headerBg, smallTitle, bigTitle, description, btnColor, btnRedirect }) {
  return (
    <section id='home' className='relative h-[650px]' style={{
      ...
      <div className="dark-overlay">
        <div className="container flex-col flex max-w-6xl mx-auto px-5 py-12 z-10">
          ...
          <div className="max-w-6xl flex flex-col items-center mt-20 text-white md:mt-32 md:items-start">
            ...
            <h1 className='text-3xl text-center font-sans font-black uppercase md:text-7xl md:text-left md:mt-0'>{bigTitle}</h1>
