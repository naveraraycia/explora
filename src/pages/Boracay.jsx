      ...
      <section id="tour-packages">
        ...
        <div className="container flex flex-col space-y-10 items-start mt-32 text-white max-w-6xl px-10 mx-auto">
          ...
          <div className="mx-auto flex flex-col text-center items-center">
            ...
            <h1 className='text-5xl mt-3 font-sans font-black uppercase md:mt-0'>Boracay tour packages</h1>
          </div>
          ...
          <div className="max-w-6xl w-full flex flex-col items-start text-white">
            ...
            <div className="flex flex-col space-y-10 my-10 md:flex-row md:space-y-0 md:space-x-10">
                ...
                <RoomCard color='dark blue' title='Rooms near the beach' caption='Continue feeling the ocean summer vibes as you stay on this luxury room near the beach.' cardImg={hotelImg1} />
               
                <RoomCard color='dark blue' title='Ocean Jacuzzi' caption='Bathe under the sunset in this Jacuzzi pool while you enjoy the ocean breeze. Bath essentials included.' cardImg={hotelImg2} />

                <RoomCard color='dark blue' title='Finest Filipino Cousine' caption='Have a taste of authentic Filipino Cousine to complete your overall trip in the Philippines.' cardImg={hotelImg3} />
        ...
        <section id="purchase-section" className="mt-20">
          ...
          <div className="relative px-10 py-20 md:px-20">
