      ...
      <div className="container flex flex-col space-y-10 items-start mt-32 text-white max-w-6xl px-5 mx-auto">
        ...
        <div className="max-w-6xl w-full flex flex-col items-start text-white">
          ...
          <div className="flex flex-col space-y-10 my-10 md:flex-row md:space-y-0 md:space-x-10">
            <RoomCard color='teal' title='Luxury Room' caption='Relax from the trip and settle down on a luxury 5 star hotel room near the town.' cardImg={hotelImg1} />  
            <RoomCard color='teal' title='Divine Bath' caption='Take a break from the trip by relaxing in a luxury hotel bathroom. Bath essentials included.' cardImg={hotelImg2} />
            <RoomCard color='teal' title='Finest Filipino Cousine' caption='Have a taste of authentic Filipino Cousine to complete your overall trip in the Philippines.' cardImg={hotelImg3} /> 
          </div>
        </div>
      </div>
      ...
      <section id="purchase-section" className="mt-20">
        ...
        <div className="relative px-5 py-20 md:px-20"> 
          <div className="flex flex-col space-y-10 xl:flex-row xl:space-x-10 xl:space-y-0">
            ...
            <div className="xl:hover:scale-110 hover:shadow-lg hover:cursor-pointer flex flex-1 items-stretch">
              <PricingCard color='teal' location='Palawan' promo='premium' price={1999} deals={['Avail ALL the tour packages (tour guide included)', 'Free Hotel Reservation for 7 days', 'Round trip flight accomodation']} />
            </div>

            <div className="xl:hover:scale-110 hover:shadow-lg hover:cursor-pointer flex flex-1 items-stretch">
              <PricingCard color='teal' location='Palawan' promo='leveled up' price={1299} deals={['Choose ANY 2 from the tour packages (tour guide included)', 'Free Hotel Reservation for 6 days', 'Round trip flight accomodation']} />
            </div>
          </div>
        </div>
      </section>
