  ...
  return (
    ...
    <div className="container flex-col flex max-w-6xl mx-auto px-5 py-12 z-10 md:flex-row">
      ...
      <div className=" flex flex-col items-center mt-20 text-gray md:max-w-6xl md:mx-auto md:items-center md:text-center md:mt-0">
          <h2 className="text-xl font-sans text-center font-normal tracking-widest uppercase md:text-left md:text-3xl">When</h2>
          <h1 className='text-3xl text-center font-sans font-black text-blueGreen uppercase md:text-left md:mt-0 md:text-5xl'>we started</h1>
    ...
    <div className="container flex-col flex max-w-6xl mx-auto px-5 py-12 z-10 md:flex-row">
      <div className=" flex flex-col items-center mt-20 text-gray md:max-w-6xl md:mx-auto md:items-center md:text-center md:mt-0">
          <h2 className="text-xl font-sans text-center font-normal tracking-widest uppercase md:text-left md:text-3xl">Why</h2>
          <h1 className='text-3xl text-center font-sans font-black text-blueGreen uppercase  md:text-left md:mt-0 md:text-5xl'>we started</h1>
